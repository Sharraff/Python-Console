...
class TestBaseModel(unittest.TestCase):
    """
    class for testing BaseModel class method
    """

    @classmethod
    def setUpClass(cls):
        """
        Set up class method for the doc test
        """
    ...
    def tearDown(self):
        """
        destroy method for BM object of BaseModel 
        """
        self.BM = None
    ...
    def test_func_docstrings(self):
        """
        Tests if methods docstring documentation exist
        """
    ...
    def test_basic_attribute_set(self):
        ...
        """
        self.BM.first_name = 'Sharraff'
        self.BM.last_name = 'Ibrahim'
        self.assertEqual(self.BM.first_name, 'Sharraff')
        self.assertEqual(self.BM.last_name, 'Ibrahim')
    ...
    def test_str(self):
        ...
        """
        string = str(self.BM)
        BMid = "[{}] ({}) {}".format(self.BM.__class__.__name__,
                                    self.BM.id,
                                    self.BM.__dict__)
        test = BMid in string
    ...
    def test_id_type_string(self):
        """
        test if id in BaseModel is a string 
        """
